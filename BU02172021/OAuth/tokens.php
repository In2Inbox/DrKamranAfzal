...
class oauthClass {
	...
	function __construct() {
		...
		$json=file_get_contents('oauth.json');
		// show that the file read is working
		$log=new LogFileClass('tokens.log');
		$log->lfWriteLn('absPath = '.$this->abspath);
		$log->lfWriteLn('file read = '.$json);
